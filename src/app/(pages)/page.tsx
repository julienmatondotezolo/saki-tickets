...
export default function Home() {
  return (
    <>
      <Navigation />
      <main className="relative flex w-full min-h-screen flex-col items-center justify-between p-24">
        ...
        <article className="pt-8 w-full flex flex-col flex-wrap justify-center text-center space-y-8">
          <h1 className="font-medium text-5xl text-foreground dark:gradientWhiteText">
            Drag your PDF file underneath.
            <br />
            make it <span className=" text-secondary-pink">kawai</span>
          </h1>
          <p className="text-grey dark:text-grey-blue sm:w-full md:w-5/12 w-full m-auto">
            Drag your pdf file underneath and it will be cropped to your desired
            size. Your file will be automatically downloaded on your PC. <br />
            <span>
              Don&apos;t forget to make it <b>Kawai.</b>
            </span>
          </p>
        </article>
        <PdfDropZone />
