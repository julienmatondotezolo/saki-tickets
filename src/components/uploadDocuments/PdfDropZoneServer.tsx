...
const PdfDropZoneServer: React.FC<PdfDropZoneProps> = () => {
  return (
    <form action={upload}>
      <div
        className="relative group flex flex-col items-center border-dashed border-2 p-5 text-center min-h-24 mb-4 rounded-lg hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30 cursor-pointer"
      >
        <Image
